                ...
                <div class="col-sm-10 text-left"> 
                    ...
                    <div class="panel panel-default" style="overflow:scroll;height:400px;width:100%;overflow:auto">
                        ...
                        <table class="table table-hover table-fixed" height="100px">
                            <thead>
                                <tr> 
                                    <td> Nom Titre </td> <td> Marché </td> <td> Date dernier courtage </td> <td> Cours actuel (%) </td> <td> Sélection </td>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr> 
                                    ...
                                    <td > <%= cour.getCours()%> </td>
                                    <td > <input id="CB<%= cour.getId() %>" type="checkbox" onchange="setCheckBoxName(<%=cour.getId() %>)"></td>
                            </tr>                                 
                            <% } %>
                            </tbody>
                        </table>
